export const navItems = [
  ...
  export const gridItems = [
  ...
  
    {
      ...
      imgClassName: "absolute right-0 bottom-0 md:w-96 w-60 z-50",
  ...
  export const workExperience = [
    ...
    {
      id: 2,
      title: "Mobile App Dev - Sohan Think",
